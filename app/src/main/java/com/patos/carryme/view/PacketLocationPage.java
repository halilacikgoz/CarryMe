...
public class PacketLocationPage extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Polyline polyline = mMap.addPolyline(new PolylineOptions().add(new LatLng(currentCar.get_s_latitude(),currentCar.get_s_longitude()),
                carDestination).width(5).color(Color.GREEN));

        MarkerOptions finishMarker = new MarkerOptions().position(carDestination).icon(BitmapDescriptorFactory.
